...
class InstallMyAISupabaseUser extends BaseAuthUser {
  InstallMyAISupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> installMyAISupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = InstallMyAISupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
